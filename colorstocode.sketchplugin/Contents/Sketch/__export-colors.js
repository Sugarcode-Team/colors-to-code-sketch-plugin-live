...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/export-colors.js");
/******/ })
/************************************************************************/
/******/ ({
...
module.exports = "file://" + String(context.scriptPath).split(".sketchplugin/Contents/Sketch")[0] + ".sketchplugin/Contents/Resources/_webpack_resources/4272692f29dd5090ed3fbdf3ce96784b.html";

/***/ }),

/***/ "./src/export-colors.js":
/*!******************************!*\
  !*** ./src/export-colors.js ***!
  \******************************/
...
var webviewIdentifier = 'colortocode.webview';
...
function onSelection(context) {
  var colors = getSelectedItems();
  var browserWindow = getWindow();
  var webContents = browserWindow.webContents;
  webContents.executeJavaScript("setData(".concat(JSON.stringify(colors), ")")).catch(console.error);
}
...
//# sourceMappingURL=__export-colors.js.map